/** THEBOBOS**/
"use strict";
angular.module("frontendAngularClientApp").controller("MasterController", ["$scope", "$rootScope", "$state", "userService", "$location", "SweetAlert", function ($scope, $rootScope, $state, userService, $location, SweetAlert) {

    ///api / customer / avatar

    //$rootScope.CustomerEntity; //iumplicit
